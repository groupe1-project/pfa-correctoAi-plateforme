...
const CorrectPage = () => {
    ...
    const languages = [
        ...
        { code: 'en', name: 'Anglais' , flag: 'GB' },
        { code: 'es', name: 'Espagnol' , flag: 'ES' },
        { code: 'ar', name: 'Arabe' , flag: 'SA' },
    ];
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            ...
            // Créer un nom de fichier avec l'extension correcte
            const fileName = file.name;
            const fileExtension = fileName.split('.').pop();
            const correctedFileName = `corrected_${fileName}`;
            ...
            if (error.response) {
                ...
                alert(`Erreur lors de la correction: ${errorMessage}`);
            } else {
